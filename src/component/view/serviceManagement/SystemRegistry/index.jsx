...
const SystemRegistry = (props)=>{
     ...
     const columns=[
        ...
        { title: '所属用户', dataIndex: 'linkMan', key:'linkMan' },
        { title: '是否记录日志', dataIndex: 'approveStatus', key:'approveStatus', render:(text)=>getApproveStatusText(text) },//1未审批，2 已审批
        { title: '是否映射', dataIndex: 'log', key:'log', render:(text)=>getApproveStatusText(text) },//1未审批，2 已审批
