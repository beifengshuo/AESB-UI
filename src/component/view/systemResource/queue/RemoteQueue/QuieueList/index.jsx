...
import { getList } from "@/api/systemResource/queue/remote";
...
const QuieueList = ({addTab,panes})=>{
    const columns=[
        ...
        { title: '目标路由名', dataIndex: 'remoteRouter', key:'remoteRouter',ellipsis:true},
        { title: '目标队列/主题名', dataIndex: 'remoteDest', key:'remoteDest',ellipsis:true,},
    ...
    const searchs=[
        ...
        {label:'目标路由名', name:'remoteRouter' },
        {label:'目标队列/主题名', name:'remoteDest' },
    ]
    return(
        <TableTemplate 
            buttons={buttons}
